...
<html lang="en">
  ...
  'use strict';
  var data = {
    labels: ["Users", "Products", "Orders", "Delivered Orders", "Processing Orders", "Sold Products"],
    datasets: [{
      label: '# of Votes',
      data: [
  ...
  var doughnutPieData = {
    datasets: [{
      data: [{!! json_encode($total_users) !!}, {!! json_encode($total_product) !!}, {!! json_encode($total_orders) !!}],
      backgroundColor: [
        'rgba(255, 99, 132, 0.5)',
        'rgba(54, 162, 235, 0.5)',
        'rgba(255, 206, 86, 0.5)',
